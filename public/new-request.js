                ...
                <form id="newRequestForm" style="margin-top:18px;">
                    <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(250px, 1fr));gap:16px;margin-bottom:24px;">
                        ...
                        <div style="display:flex;flex-direction:column;gap:8px;">
                            ...
                            <input type="number" name="classes" min="1" max="8" required value="${this.escapeAttr(classesValue)}"
                                   style="padding:12px;border-radius:8px;border:1px solid #d1d5db;font-size:14px;"
                                   id="classes" class="form-input">
                            <div style="font-size:12px;color:#6b7280;margin-top:4px;">
                                <i class="fas fa-info-circle"></i> 1-8 пара
                            </div>
                        </div>
